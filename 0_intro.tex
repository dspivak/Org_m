...
In \cref{sec:background} we introduce the $\smcat^\sharp$-enriched category $\org$ as well as the adjunctions which define the free monad monad $\free$ and the cofree comonad comonad $\cofree$. 
